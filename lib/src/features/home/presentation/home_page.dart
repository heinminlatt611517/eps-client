import 'package:eps_client/src/features/home/data/home_repository.dart';
...
class _HomePageState extends ConsumerState<HomePage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      await ref.read(homeRepositoryProvider).saveFcmToken();
    });
  }
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Hello | ${SecureStorage().getUserName()}',
